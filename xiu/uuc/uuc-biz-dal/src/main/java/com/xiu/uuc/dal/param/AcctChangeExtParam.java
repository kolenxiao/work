 ...
 */
public class AcctChangeExtParam extends BaseParam {
	
	public AcctChangeExtParam(){
		
	}
	
	public AcctChangeExtParam(final Long acctItemId,final String acctTypeCode ,final Date validTime, final Date expireTime){
