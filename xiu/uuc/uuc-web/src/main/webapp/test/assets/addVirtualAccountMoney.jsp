...
Result addVirtualAccountMoney(AcctItemDTO acctItemDTO,AcctChangeDTO acctChangeDTO);
	...
	<form name="inputForm" action="assetsManager!addVirtualAccountMoney.action" method="post">
		<table>
			<tr>
				<td>*用户ID:</td>
			...
			<tr>
				<td>*账目类型:</td>
				<td><input name="acctItemDTO.acctTypeCode"/>（01：可提现 02：不可提现）</td>
			</tr>
			<tr>
				<td>*充值金额:</td>
