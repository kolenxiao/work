...
<script type="text/javascript">
	...
	//取消操作
	function doBack() {
		location.href = "certificate!doList.action";
	}
...
<body id="cnt_body" class="data_view">
	<s:form id="certificateForm" name="certificateForm" action=""
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<th scope="row"><s:text
						name="sdp.sce.dp.admin.certificate.public"></s:text>：</th>
				<td><s:if test="%{null != signedFileName}">
						<s:property value="signedFileName" />
						<br />
					</s:if> <s:file type="file" id="signed" name="signed" size="30"
						valid="filter" allow="cer,pem"
						errmsg="certificate_signed_file_allow"></s:file> <strong
					style="color: #F00;">*</strong> <span id="errMsg_signed"
					style="color: #FF0000"></span></td>
			</tr>
			<tr>
				<th scope="row"><s:text
						name="sdp.sce.dp.admin.certificate.private"></s:text>：</th>
				<td><s:if test="%{null != privateKeyFileName}">
						<s:property value="privateKeyFileName" />
						<br />
					</s:if> <s:file type="file" id="privateKey" name="privateKey" size="30"
						valid="filter" allow="pk8"
						errmsg="certificate_privateKey_file_allow"></s:file> <strong
					style="color: #F00;">*</strong> <span id="errMsg_privateKey"
					style="color: #FF0000"></span></td>
			</tr>
