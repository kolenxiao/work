...
<s:form id="usrApiForm" name="usrApiForm" action="user!gotoUserselfEdit.action" method="post" cssStyle="margin:0" theme="simple">
...
<div class="btnlistbar" align="left">
  <input class="inputstyle" type="button" value="修改" id="btn_save" onclick="doEdit()"/>
  <input class="inputstyle" type="button" value="返回" onclick="doBack()"/>
</div>
