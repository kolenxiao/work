...
<body id="cnt_body">
	<div id="position">
		<p>
			<s:text name="sdp.sce.dp.admin.global.label.current.position" />&gt;精选页版块管理&gt;新增元素
		</p>
		<div id="pright"></div>
	</div>
	<div class="view_nav">
	...
	<s:form id="appRecommendPanelItemForm" name="appRecommendPanelItemForm"
		action="appRecommendPanelItem!doSaveItem.action" method="post" cssStyle="margin:0"
		theme="simple">
		<s:token/>
		<div class="data_view">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td>
                        <s:select name="aformObj.type" id="aformObj.type"
							list="#{'1':'应用','2':'专题','3':'文本'}" label="元素类型" onchange="onChangeType()"></s:select>
					</td>
				</tr>
				<tr>
				   	<th scope="row">
					...
					<td>
                       ...
                       <input type="text" name="showName" id="showName" readonly="readonly" style="height:20px;width:220px;"/>
