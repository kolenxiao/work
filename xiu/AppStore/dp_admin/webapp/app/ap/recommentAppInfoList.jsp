...
<script type="text/javascript">
	...
	function jumpPage(no) {
		url = 'dpAppInfo!toAddRecommentList.action?';
	...
	function doChange(obj) {
		...
		url = 'dpAppInfo!toAddRecommentList.action?limit=' + pageSizeVal;
		//表单提交
			...
			$("#dialog_btn_conform")
					.click(function() {
								$.ajax({
											cache : false,
											async : false,
											url : 'appRecommend!doCommend.action',
											type : 'POST',
											data : parm,
											dataType : 'json',
											error : function(msg) {
											...
											success : function(response) {
												...
												if (dataObj && dataObj.success) {
													parent.document.getElementById("mainFrame").src="appRecommend!doSearchRecommendList.action";
...
<div class="btnlistbar">
	<input class="inputstyle" onclick="confirmChoose()"
