...
function dialogList(dT,dW,dH,dData,dstyle,nobtnlist,tipstyle,obj)
{
	var headH = 61;
	...
	if(dstyle == 0){
		if(tipstyle == 0){
	        $("body").append("<div id='dialog_bg'></div><div id='dialog'><div id='dialog_title'>"+dT+"<div id='dialog_close'></div></div><iframe scrolling='auto' frameborder='0' width='100%' height='auto' id='dialogFrame' name='dialogFrame' src='"+dData+"' ></iframe><div id='dialog_btnlist'><input class='inputstyle' type='button' value='关 闭'/></div></div>");
	    }else if(tipstyle == 1){
			$("body").append("<div id='dialog_bg'></div><div id='dialog'><div id='dialog_title'>"+dT+"<div id='dialog_close'></div></div><table id='dialogFrame' width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td scope='row' align='center' valign='middle'>"+dData+"</td></tr></table><div id='dialog_btnlist'><span id='button_conform'><input class='inputstyle' id='dialog_btn_conform' type='button' value='确 定'/></span></div></div>");
			$("#dialog img").css({margin:"0 5px 0 0"});
		}else{
			$("body").append("<div id='dialog_bg'></div><div id='dialog'><div id='dialog_title'>"+dT+"<div id='dialog_close'></div></div><table id='dialogFrame' width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td scope='row' align='center' valign='middle'>"+dData+"</td></tr></table><div id='dialog_btnlist'><span id='button_conform'><input class='inputstyle' id='dialog_btn_conform' type='button' value='确 定'/></span><span id='button_cancel'><input class='inputstyle'  type='button' value='取 消'/></span></div></div>");
		}
	}else{
		//是否需要"确定"和"取消"按钮
		if(nobtnlist==0){
			  $("body").append("<div id='dialog_bg'></div><div id='dialog'><div id='dialog_title'>"+dT+"<div id='dialog_close'></div></div><iframe scrolling='auto' frameborder='0' width='100%' height='auto' id='dialogFrame' name='dialogFrame' src='"+dData+"' ></iframe><div id='dialog_btnlist'></div></div>");
		}else{
			$("body").append("<div id='dialog_bg'></div><div id='dialog'><div id='dialog_title'>"+dT+"<div id='dialog_close'></div></div><iframe scrolling='auto' frameborder='0' width='100%' height='auto' id='dialogFrame' name='dialogFrame' src='"+dData+"' ></iframe><div id='dialog_btnlist'><span id='button_conform'><input class='inputstyle' id='dialog_btn_conform' type='button' value='确 定'/></span><span id='button_cancel'><input class='inputstyle' type='button' value='取 消'/></span></div></div>");
		}
